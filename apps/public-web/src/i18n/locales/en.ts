...
export const en = {
  ...
  reader: {
    ...
    accountSettingsBody: "These choices sync with the TickBase News mobile app. This website also uses your appearance preference; its language and event filters remain separately controlled in the header and feed.",
    contentLanguage: "News content language",
    contentLanguageHint: "Choose the news content language used by the mobile app.",
    traditionalChinese: "Traditional Chinese",
    english: "English",
    minSeverity: "Minimum event priority",
    minSeverityHint: "Choose the minimum priority for the mobile app's latest feed.",
