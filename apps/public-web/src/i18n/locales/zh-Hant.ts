...
export const zhHant = {
  ...
  reader: {
    ...
    accountSettingsBody: "這些選項會套用至網站與手機 App。網站介面語言獨立切換，列表網址中的篩選條件可覆蓋預設優先級。",
    contentLanguage: "新聞內容語言",
    contentLanguageHint: "選擇網站與手機 App 使用的新聞內容語言。",
    traditionalChinese: "繁體中文",
    english: "English",
    minSeverity: "最低事件優先級",
    minSeverityHint: "選擇網站與手機 App 最新事件列表的預設最低優先級。",
