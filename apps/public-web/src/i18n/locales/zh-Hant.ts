...
export const zhHant = {
  ...
  account: {
    loading: "正在檢查帳戶",
    unavailable: "帳戶服務暫時無法使用。",
    retry: "重新載入帳戶",
    newsPro: "NEWS PRO",
    free: "免費",
    accountSubscription: "帳戶與訂閱",
    signOut: "登出",
    signingOut: "正在登出...",
  ...
  auth: {
    signInTitle: "登入",
    signInBody: "使用 TickBase 帳戶管理新聞偏好、通知與每日摘要。",
    registerTitle: "建立帳戶",
    registerBody: "建立一個 TickBase 帳戶，保存 News 偏好與投遞設定。",
    name: "姓名",
    email: "Email",
    password: "密碼",
    ...
    noAccount: "還沒有 TickBase 帳戶？",
    haveAccount: "已經有帳戶？",
    passwordMismatch: "兩次輸入的密碼不一致。",
    genericError: "目前無法完成帳戶請求。"
  },
  reader: {
    eyebrow: "個人閱讀體驗",
    title: "閱讀偏好",
    body: "將新聞語言、事件優先級與外觀偏好儲存在 TickBase 帳戶。",
    loading: "正在載入閱讀偏好",
    signInTitle: "登入後管理閱讀偏好",
    signInBody: "請先登入 TickBase 帳戶，再回到此頁。",
    signIn: "登入 TickBase",
    loadError: "閱讀偏好暫時無法使用。",
    retry: "重試",
    accountSettings: "帳戶同步設定",
    accountSettingsBody: "這些選項會與 TickBase News 手機 App 同步。網站也會套用外觀偏好；介面語言及事件篩選仍分別由頁首與列表控制。",
    contentLanguage: "新聞內容語言",
    contentLanguageHint: "選擇手機 App 使用的新聞內容語言。",
    traditionalChinese: "繁體中文",
    english: "English",
    minSeverity: "最低事件優先級",
    minSeverityHint: "選擇手機 App 最新事件列表的最低優先級。",
    severityAll: "所有事件（C 以上）",
    severityWatch: "關注以上（B）",
    severityHigh: "高影響以上（A）",
    severityMajor: "僅重大事件（S）",
    colorScheme: "外觀",
    colorSchemeHint: "選擇閱讀時偏好的色彩模式。",
    system: "跟隨系統",
    light: "淺色",
    dark: "深色",
    save: "儲存偏好",
    saving: "儲存中…",
    saved: "閱讀偏好已儲存至帳戶。",
    saveError: "無法儲存閱讀偏好，請再試一次。"
  },
  topics: {
    eyebrow: "探索",
    title: "主題",
    body: "依照目前出現在 TickBase News 的主題瀏覽公開事件。",
    loading: "正在載入主題...",
    emptyTitle: "目前沒有主題",
    emptyBody: "公開事件同步後，相關主題會顯示在這裡。",
    eventCount: (count: number) => `${count} 則事件`
  },
  notifications: {
    eyebrow: "個人投遞",
    title: "新聞通知",
