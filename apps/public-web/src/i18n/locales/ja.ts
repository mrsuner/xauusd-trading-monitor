...
export const ja = {
  ...
  reader: {
    ...
    accountSettingsBody: "これらの設定は TickBase News モバイルアプリと同期します。このサイトにも外観設定が適用されます。表示言語とイベント絞り込みはヘッダーと一覧で個別に操作できます。",
    contentLanguage: "ニュース本文の言語",
    contentLanguageHint: "モバイルアプリで使うニュース本文の言語を選択します。",
    traditionalChinese: "繁体字中国語",
    english: "英語",
    minSeverity: "イベントの最低優先度",
    minSeverityHint: "モバイルアプリの最新フィードの最低優先度を選択します。",
