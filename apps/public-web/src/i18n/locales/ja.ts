...
export const ja = {
  ...
  reader: {
    eyebrow: "閲覧体験",
    title: "閲覧設定",
    body: "ニュースの言語、イベントの優先度、表示設定を TickBase アカウントに保存します。",
    loading: "閲覧設定を読み込み中",
    signInTitle: "ログインして閲覧設定を管理",
    signInBody: "TickBase アカウントにログインしてから、このページに戻ってください。",
    signIn: "TickBase にログイン",
    loadError: "閲覧設定を一時的に読み込めません。",
    retry: "再試行",
    accountSettings: "アカウントで同期する設定",
    accountSettingsBody: "これらの設定は Web とモバイルアプリの両方に適用されます。サイトの表示言語は別に切り替えられ、URL のフィルターは既定の優先度を上書きできます。",
    contentLanguage: "ニュース本文の言語",
    contentLanguageHint: "Web とモバイルアプリで使うニュース本文の言語を選択します。",
    traditionalChinese: "繁体字中国語",
    english: "英語",
    minSeverity: "イベントの最低優先度",
    minSeverityHint: "Web とモバイルアプリの最新フィードで使う既定の最低優先度を選択します。",
    severityAll: "すべてのイベント（C 以上）",
    severityWatch: "注目以上（B）",
    severityHigh: "高影響以上（A）",
    severityMajor: "重大のみ（S）",
    colorScheme: "外観",
    colorSchemeHint: "閲覧時の配色を選択します。",
    system: "システムに合わせる",
    light: "ライト",
    dark: "ダーク",
    save: "設定を保存",
    saving: "保存中…",
    saved: "閲覧設定をアカウントに保存しました。",
    saveError: "閲覧設定を保存できませんでした。もう一度お試しください。"
  },
  topics: {
    eyebrow: "探索",
    title: "トピック",
