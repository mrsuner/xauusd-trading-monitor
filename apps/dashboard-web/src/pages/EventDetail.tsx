  ...
  return (
    <>
      ...
      <div className="mb-4 grid gap-3 md:grid-cols-5">
        <div className="rounded border border-base-300 bg-base-100 p-3"><div className="text-xs text-base-content/50">Severity</div><SeverityBadge value={event.severity} /></div>
        <div className="rounded border border-base-300 bg-base-100 p-3"><div className="text-xs text-base-content/50">Relevance</div><Score value={event.relevance_score} /></div>
        <div className="rounded border border-base-300 bg-base-100 p-3"><div className="text-xs text-base-content/50">Confidence</div><Score value={event.confidence} /></div>
        <div className="rounded border border-base-300 bg-base-100 p-3"><div className="text-xs text-base-content/50">Detected</div>{formatTime(event.detected_at)}</div>
        <div className="rounded border border-base-300 bg-base-100 p-3"><div className="text-xs text-base-content/50">Official</div><OfficialBadge value={event.official_level} /></div>
      </div>

      <section className="mb-4 rounded border border-base-300 bg-base-100 p-4">
        <h2 className="mb-3 font-semibold">Raw Items</h2>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <section className="rounded border border-base-300 bg-base-100 p-4">
          ...
          <div className="space-y-3">
            {event.claims.length === 0 ? <div className="text-sm text-base-content/50">No claims extracted.</div> : null}
        ...
        <section className="rounded border border-base-300 bg-base-100 p-4">
          ...
          <div className="space-y-3">
            {event.alerts.length === 0 ? <div className="text-sm text-base-content/50">No alerts recorded.</div> : null}
